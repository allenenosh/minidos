...
parser = argparse.ArgumentParser(
    description="MiniD0S, low bandwidth stress test tool for websites"
)
...
def main():
    ...
    while True:
        try:
            logging.info(
                "Sending Stay-awake headers... Socket count: %s", len(list_of_sockets)
            )
